...
class Import extends SupportDatabase {
    ...
    const TAB = '    ';
    const CLASS_HEADER = '<?php%1$sif (!defined(\'PAPRIKA_LIBRARY_PATH\')) die(\'Not allowed\');%1$s%1$s';
