...
abstract class BasePresentation extends SupportPresentation {
     ...
     * @throws PresentationException
     */
    public function create(HttpRequest $httpRequest, $customKeys = null, $showNeedsConfirmation = true, $submitCustomText = null, $usesTransaction = false) {
        $httpResponse = new HttpResponse();
        try {
            if ($httpRequest->getRequest()) {
                try {
                    $this->castRequestToEntity($this->entity, $httpRequest->getRequest());
                    $this->business->save($this->entity, $usesTransaction);
     ...
     * @throws PresentationException
     */
    public function update(HttpRequest $httpRequest, $customKeys = null, $showNeedsConfirmation = true, $submitCustomText = null, $usesTransaction = false) {
        $httpResponse = new HttpResponse();
        try {
